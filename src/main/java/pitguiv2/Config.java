...
public class Config {
    ...
    public boolean hasQuantification(String run){
    ...
    public Set<String> getRunSamples(String run){
    ...
    public String getRunType(String run){
        if(config.getJSONObject("mzml").getJSONObject(run).keySet().contains("SILAC"))
            return "SILAC";
        return null;
    }
