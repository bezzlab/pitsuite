...
(function($) {
	...
	function calculateTheoreticalSeries(container, selectedIons) {
		...
		if(selectedIons) {
            ...
            console.log(JSON.parse(JSON.stringify(ionSeries)))
	...
	function initContainer(container) {
		...
		parentTable += '<tr> ';
		parentTable += '<td style="background-color: white; valign="top" align="center"> ';
